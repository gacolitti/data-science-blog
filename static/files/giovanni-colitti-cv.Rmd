...
- Developed Shiny apps to extract / summarize data,
...
- Developed two R packages for cross-validation of time-series data with irregular 
  time slices (tidyroll), and to interface with the CoAgMET weather network API (coagmetr).
