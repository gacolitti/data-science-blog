...
- Developed Shiny apps to summarize data,
  explore data through interactive maps, and create PowerPoint presentations.
- Predicted machine unloading events with 90% accuracy.
- Designed flexible visualizations and tables of customer KPIs. 
