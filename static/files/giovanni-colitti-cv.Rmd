...
- Contributed to the development of a Kubernetes cost model, wrote an API 
...
- Automated tooling for customer chargebacks and built tools to estimate Kubernetes quota 
  clawbacks for presentations to senior leadership.
