...
Used a unique dataset on county-level concealed firearms permits and applied two-stage least squares estimation & poisson regression models to show that concealed firearms do not decrease crime.
